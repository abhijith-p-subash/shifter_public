          ...
          <div className="relative z-10 flex flex-col lg:flex-row justify-center items-center h-full container mx-auto p-4 mt-20">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className=" mb-8">
                ...
                >
                  ...
                  <p className="text-white">We are here to make your relocation stress-free</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <p className="mt-4 text-gray-600">
                    ...
                    within your budget. Quality moving services shouldn’t break
                    the bank.
                  </p>
                </motion.div>
            ...
            >
              ...
              <p className="mt-4 text-lg text-white max-w-lg">
                ...
                handling every aspect of your relocation with professionalism
            ...
            <div className="grid grid-cols-1 md;grid-cols-2 lg:grid-cols-2  gap-4">
              ...
              <div > 
                <p className="text-gray-900">
                  ...
                  right professionals. From delicate artwork and furniture to
                  your everyday essentials, every item in your home deserves
                  careful handling and damage-free transportation. With today’s
                  fast-paced lives, delays can disrupt your schedule, making an
                  efficient move essential.
                </p>
                <br />
                <p className="text-gray-900">
                  {" "}
