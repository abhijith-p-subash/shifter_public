  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative bg-gradient-to-r from-primary to-darkBlue-500 py-10 mt-20 lg:mt-0">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <svg className="absolute top-0 left-0 w-full h-full animate-pulse opacity-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path fill="#FFCF54" fillOpacity="0.6" d="M0,256L1440,160L1440,320L0,320Z"></path>
        </svg>
      </div>
